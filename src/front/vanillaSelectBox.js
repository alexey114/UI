...
let zList = document.querySelector(".__select");
...
function vanillaSelectBox(domSelector, options) {
    ...
    this.list = document.querySelector('.__select');
    this.rootToken = null;
    this.main;
    this.button;
    this.title;
    ...
    this.createTree = function () {
        ...
        if (self.userOptions.stayOpen) {
            ...
            this.button.classList.add('vsb-button');
